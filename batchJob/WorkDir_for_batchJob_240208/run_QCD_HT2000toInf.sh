...
xrdcp -r -f $NewOutputName "root://eosuser.cern.ch//eos/user/j/junghyun/ttHH/ADL_result/240208/QCD_HT2000toInf"

NewCsvName="QCD_HT2000toInf_table_$ClusterId_$ProcId.csv"
mv ttHHcsv.csv $NewCsvName
xrdcp -r -f $NewCsvName "root://eosuser.cern.ch//eos/user/j/junghyun/ttHH/ADL_result/240208/QCD_HT2000toInf"
