...
JobID = "240124_objectUpdates" # Whatever ID you want
CutLang_path = os.path.abspath("../CutLang")
SampleType = "CMSNANO"
CutLangExeScriptName = "CLA1" # This file is in [ script_forRunCL ] directory
ADLScriptName = "ttHH_had_v2_4" # This file is in [ script_forRunCL ] directory
...
NumberOfEvent = "" # If you don't define # of events, then all events will be run
# If you want to full run use like this [ NumberOfEvent = "" ]
